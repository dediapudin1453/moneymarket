...
class Chat_whatsapp_model extends CI_Model {

	private $_table = 't_chat_whatsapp';
	private $_column_order = array(null, 'chat','type');
	private $_column_search = array('chat','type');
