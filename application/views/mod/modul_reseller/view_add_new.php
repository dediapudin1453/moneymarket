...
<div class="content">
	<div class="block">
		...
		<div class="box-content">
			<form action="<?= admin_url() ?>modul_reseller/add_new_save" method="POST">
				<div class="row">
					<div class="col-md-9">
						<!-- Title -->
						...
						<div class="form-group mb-4">
							<select name="type" id="type" class="form-control post-title-input" required>
								<option value="Photo Promotion">Photo Promotion</option>
								<option value="Copywriting">Copywriting</option>
								<option value="Panduan Reseller">Panduan Reseller</option>
								<option value="Digital Marketing">Digital Marketing</option>
								<option value="Sistem Komisi">Sistem Komisi Reseller </option>
							</select>
						</div>
						<!--/ e -->
					...
					<div class="col-md-3 " style="min-width:120px;">
						<div id="sticky">
							...
							<hr>
							<div>
								<button type="submit" class="button btn-primary submit_add">Submit</button>
