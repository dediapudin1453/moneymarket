				...
				<div class="row">
					<div class="col-md-9">
						...
						<div class="form-group mb-4">
							<input type="text" name="title" id="title" class="form-control post-title-input" value="<?=!empty(set_value('name')) ? set_value('name') : $res_pages['name'];?>" placeholder="<?=lang_line('form_label_title');?>">
						...
						<div class="form-group mb-0">
							...
							<textarea id="Content" name="content" class="form-control" rows="11" style="border-radius:0px;"><?=!empty(set_value('comment')) ? set_value('comment') : $res_pages['comment'];?></textarea>
