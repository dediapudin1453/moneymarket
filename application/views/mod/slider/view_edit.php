			...
			<?=form_open('','id="form_update" autocomplete="off"');?>
				<div class="row">
					<div class="col-md-9">
						...
						<div class="form-group mb-4">
							<input type="text" name="subtitle" id="subtitle" class="form-control post-title-input" value="<?=!empty(set_value('subtitle')) ? set_value('subtitle') : $res_pages['subtitle'];?>" placeholder="<?php echo lang_line('form_label_subtitle');?>">
						</div>
						<!--/ Title -->
						...
						<!-- <div class="form-group mb-4">
							<input type="text" name="content" id="content" class="form-control post-title-input" value="<?=!empty(set_value('content')) ? set_value('content') : $res_pages['content'];?>" placeholder="<?php echo lang_line('form_label_content');?>" required>
						</div> -->
						<!--/ Content -->
					</div>
