...
<head>
    ...
    <link href="<?= content_url('plugins/linggafx.com/hyper/assets/css/vendor/dataTables.bootstrap5.css') ?>" rel="stylesheet" type="text/css" />
    <link href="<?= content_url('plugins/linggafx.com/hyper/assets/css/vendor/responsive.bootstrap5.css') ?>" rel="stylesheet" type="text/css" />
    <link href="<?= content_url('plugins/linggafx.com/hyper/assets/css/vendor/buttons.bootstrap5.css') ?>" rel="stylesheet" type="text/css" />
    <link href="<?= content_url('plugins/linggafx.com/hyper/assets/css/vendor/select.bootstrap5.css') ?>" rel="stylesheet" type="text/css" />
...
<body class="loading" data-layout="detached" data-layout-config='{"leftSidebarCondensed":false,"darkMode":false, "showRightSidebarOnStart": true}'>
            ...
            <span class="noti-icon-badge"></span>
                ...
                <li class="dropdown notification-list">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown" aria-labelledby="topbar-userdrop">
                        ...
                        <!-- item
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              <i iclass="mdi mdi-lock-outline me-1"></i>
    ...
    <!-- third party js -->
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/jquery.dataTables.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/dataTables.bootstrap5.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/dataTables.responsive.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/responsive.bootstrap5.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/dataTables.buttons.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/buttons.bootstrap5.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/buttons.html5.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/buttons.flash.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/buttons.print.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/dataTables.keyTable.min.js') ?>"></script>
    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/dataTables.select.min.js') ?>"></script>
    <!-- third party js ends -->

    <script src="<?= content_url('plugins/linggafx.com/hyper/assets/js/vendor/demo.datatable-init.js') ?> "></script>
