...
class Setting extends Admin_controller {
	...
	public function submit() 
	{
		...
		if ( $this->input->is_ajax_request() ) 
		{
			if ( $act == 'website_title' )
			{
				$value = trim($this->input->post('value'));
				$this->setting_model->update('web_title', array('value' => $value));
			}
			...
			elseif ( $act == 'email_alert' )
			{
				$value = trim($this->input->post('value'));
				$this->setting_model->update('email_alert', array('value' => $value));
			}
