			...
			?>
				<div class="row">
					<div class="col-md-9">
						...
						<div class="form-group mb-4">
							<input type="text" name="subtitle" id="subtitle" class="form-control post-title-input" value="<?php echo set_value('subtitle');?>" placeholder="<?php echo lang_line('form_label_subtitle');?>">
						</div>
						<!--/ Title -->
						...
						<div class="form-group mb-4">
							<input type="text" name="content" id="content" class="form-control post-title-input" value="<?php echo set_value('content');?>" placeholder="<?php echo lang_line('form_label_content');?>">
						</div>
						<!--/ Content -->
					</div>
