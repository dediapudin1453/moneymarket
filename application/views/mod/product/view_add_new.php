			...
			?>
				<div class="row">
					<div class="col-md-9">
						...
						<!-- subTitle -->
						<div class="form-group mb-4">
							<input type="text" name="subtitle" id="subtitle" class="form-control post-title-input" value="<?php echo set_value('subtitle');?>" placeholder="subtitle">
						</div>
						<!--/ subTitle -->
						<div class="form-group mb-4">
							<input type="text" name="leverage" id="leverage" class="form-control post-title-input" value="<?php echo set_value('leverage');?>" placeholder="Leverage" required>
						</div>
							...
							<div class="accordion post-setting" id="accordionExampleX">
								...
								<div class="card">
									...
									<div id="collapseHighlight" class="collapse show" aria-labelledby="collapse-status" data-parent="#accordionExample">
										<div class="card-body">
											<div class="form-check">
												<?php if ( !empty(set_value('highlight')) ): ?>
