...
class Popup_gambar_model extends CI_Model {

	private $_table = 't_popup_gambar';
	private $_column_order = array(null, 'picture','type');
	private $_column_search = array('picture','type');
