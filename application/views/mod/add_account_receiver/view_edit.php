				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group mb-4">
							...
							<input type="text" name="account" class="form-control post-title-input" value="<?= $res_pages['account'] ?>" <?php if ($res_pages['status_request']!='Approved') {
								echo "readonly";
							} ?>>
						</div>
						<div class="form-group mb-4">
							<label>Password</label>
							<input type="text" name="password" class="form-control post-title-input" value="<?= $res_pages['password'] ?>" <?php if ($res_pages['status_request']!='Approved') {
								echo "readonly";
							} ?>>
						</div>
						<div class="form-group mb-4">
							<label>Password Investor</label>
							<input type="text" name="password_investor" class="form-control post-title-input" value="<?= $res_pages['password_investor'] ?>" <?php if ($res_pages['status_request']!='Approved') {
								echo "readonly";
							} ?>>
						</div>
						<div class="form-group mb-4">
							<label><?= lang_line('form_label_amount') ?></label>
							<input type="text" name="amount" class="form-control post-title-input" value="<?= $res_pages['amount'] ?>" <?php if ($res_pages['status_request']!='Approved') {
								echo "readonly";
							} ?>>
						</div>
					</div>
