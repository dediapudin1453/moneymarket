				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group mb-0">
							...
							<textarea id="chat" name="chat" class="form-control" rows="11" style="border-radius:0px;"><?=!empty(set_value('chat')) ? set_value('chat') : $res_pages['chat'];?></textarea>
							<div class="form-input-error"><?=form_error('chat');?></div>
						</div>
						<!--/ Content -->
					</div>
				</div>
