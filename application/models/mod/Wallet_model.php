...
class Wallet_model extends CI_Model {
	...
	private $_table = 't_wallet';
	private $_column_order = array(null, 'user_id','amount');
	private $_column_search = array('user_id');
	...
	public function get_wallet_user($user_id) {
		return $this->db->get_where($this->_table, array('user_id' => $user_id))->row_array();
	}
	...
	{
		$query = $this->db->insert('t_wallet_history', $data);
		return $query;
	}
