...
class Step_registrasi_model extends CI_Model {

	private $_table = 't_step_register';
	private $_column_order = array(null, 'title','subtitle');
	...
	public function get_step_registrasi($id) 
	{
		$query = $this->db->where('id', $id);
