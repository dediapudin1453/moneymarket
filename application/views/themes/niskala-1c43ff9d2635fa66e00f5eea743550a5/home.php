            ...
            <div class="uk-container">
                <div class="uk-grid uk-flex uk-flex-center" data-uk-grid>
                    <div class="uk-width-1-1 uk-width-5-6@m">
                        <p class="uk-text-lead uk-margin-remove-bottom uk-text-center in-offset-top-10">Start trading with ICFX Company.</p>
                                ...
                                <div class="uk-card uk-card-primary uk-border-rounded ">
                                    <div class="uk-card-body">
                                        ...
                                        <form class="uk-grid-small" data-uk-grid>
                                            ...
                                            <div class="uk-width-1-1">
                                                <input class="uk-input uk-border-rounded" type="text" placeholder="Username">
                                            </div>
                                            <div class="uk-width-1-1">
                                            ...
                                            <div class="uk-width-1-1">
                                                <input class="uk-input uk-border-rounded" type="text" placeholder="Retype Password">
                                            </div>
                                            <div class="uk-width-1-1">
                                                <button class="uk-button uk-button-primary uk-border-rounded uk-width-expand uk-margin-small-bottom">Create Account</button>
                                            </div>
