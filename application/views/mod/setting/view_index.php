					...
					<div class="box-body">
						<div class=" table-responsive">
							<table class="table table-striped no-row-border mb-0">
								<tr>
									<td width="200" class="link-setting"><?php echo lang_line('table_web_title');?></td>
									<td class="link-setting">
										<a href="javascript:void(0)" id="website_title" data-type="text" data-pk="website_title" data-url="<?php echo admin_url('setting/submit');?>" data-msg="<?php echo lang_line('form_message_required');?>"><?php echo $this->settings->website('web_title');?></a>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="link-setting">Alert to Email</td>
									<td class="link-setting">
										<a href="javascript:void(0)" id="email_alert" data-type="text" data-pk="email_alert" data-url="<?php echo admin_url('setting/submit');?>" data-msg="<?php echo lang_line('form_message_required');?>"><?php echo $this->settings->website('email_alert');?></a>
									</td>
								</tr>
							</table>
						</div>
