...
<head>
	...
	<link href="<?=content_url('plugins/member/css/paper-dashboard.min.css')?>" rel="stylesheet"/>
		...
		<div class="sidebar" data-color="blue">
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="nav-item <?=$this->CI->menu_class('referral')?>">
						<a href="<?=member_url('referral')?>" class="nav-link">
							<i class="pe-7s-share"></i>
							<p>Referral</p>
						</a>
					</li>
					<li class="nav-item <?=$this->CI->menu_class('payments')?>">
						<a href="<?=member_url('payments')?>" class="nav-link">
					...
					<li class="nav-item <?=$this->CI->menu_class('history_report')?>">
						<a href="<?=member_url('history_report')?>" class="nav-link">
