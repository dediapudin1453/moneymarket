...
class Modul_reseller_model extends CI_Model {

	private $_table = 't_modul_reseller';
	private $_column_order = array(null, 'judul','type','active');
	private $_column_search = array('judul');
