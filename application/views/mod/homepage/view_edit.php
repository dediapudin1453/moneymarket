				...
				<div class="row">
					<div class="col-md-9">
						...
						<div class="form-group mb-4">
							<input type="text" name="title" id="title" class="form-control post-title-input" value="<?=!empty(set_value('section')) ? set_value('section') : $res_pages['section'];?>" placeholder="<?=lang_line('form_label_title');?>">
