...
<div class="content">
	...
	<div class="block">
		...
		<div class="box-content">
			<form action="<?= admin_url($this->mod.'/submit_update') ?>" method="POST">
				<?php echo form_hidden('param', encrypt($res_pages['id'])); ?>
				<div class="row">
					<div class="col-md-9">
						<!-- Title -->
						...
						<!-- tipe -->
						<div class="form-group mb-4">
							<select name="type" id="type" class="form-control post-title-input" required>
								<option value="Photo Promotion" <?php if ($res_pages['type']=='Photo Promotion') {
									echo "selected";
								} ?>>Photo Promotion</option>
								<option value="Copywriting" <?php if ($res_pages['type']=='Copywriting') {
									echo "selected";
								} ?>>Copywriting</option>
								<option value="Panduan Reseller" <?php if ($res_pages['type']=='Panduan Reseller') {
									echo "selected";
								} ?>>Panduan Reseller</option>
								<option value="Digital Marketing" <?php if ($res_pages['type']=='Digital Marketing') {
									echo "selected";
								} ?>>Digital Marketing</option>
								<option value="Sistem Komisi" <?php if ($res_pages['type']=='Sistem Komisi') {
									echo "selected";
								} ?>>Sistem Komisi Reseller </option>
							</select>
						</div>
						<!--/ e -->
