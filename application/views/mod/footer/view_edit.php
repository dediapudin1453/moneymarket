				...
				<div class="row">
					<div class="col-md-9">
						...
						<div class="form-group mb-4">
							<!-- <input type="text" name="copyright" id="copyright" class="form-control post-title-input" value="<?=!empty(set_value('copyright')) ? set_value('copyright') : $res_pages['copyright'];?>" placeholder="<?=lang_line('form_label_copyright');?>"> -->
							<textarea id="Content" name="copyright" class="form-control" rows="11" style="border-radius:0px;"><?=!empty(set_value('copyright')) ? set_value('copyright') : $res_pages['copyright'];?></textarea>
