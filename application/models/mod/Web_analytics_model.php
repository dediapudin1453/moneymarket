...
class Web_analytics_model extends CI_Model {

	private $_table = 't_web_analytics';
	private $_column_order = array(null, 'analytics','type');
	private $_column_search = array('analytics','type');
