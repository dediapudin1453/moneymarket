				...
				<div class="row">
					<div class="col-md-9">
						...
						<div class="form-group mb-4">
							...
							<input id="seotitle" type="hidden" name="seotitle" value="<?=!empty(set_value('seotitle')) ? set_value('seotitle') : $res_pages['seotitle'];?>">
						</div>
						<!--/ Title -->
						<!-- subTitle -->
						<div class="form-group mb-4">
							<input type="text" name="subtitle" id="subtitle" class="form-control post-title-input" value="<?=!empty(set_value('subtitle')) ? set_value('subtitle') : $res_pages['subtitle'];?>" placeholder="subtitle">
						</div>
						<!--/ ssubTitle -->

						<div class="form-group mb-4">
							<input type="text" name="leverage" id="leverage" class="form-control post-title-input" value="<?=!empty(set_value('leverage')) ? set_value('leverage') : $res_pages['leverage'];?>" placeholder="Leverage">
						</div>
					...
					<div class="col-md-3 " style="min-width:120px;">
						<div id="sticky">
							<div class="accordion post-setting" id="accordionExampleX">
								...
								<div class="card">
									<div class="card-header" id="collapse-category">
										<button class="btn btn-link" type="button" data-toggle="collapse" aria-expanded="true" data-target="#collapseHighlight" aria-controls="collapseHighlight">Highlight</button>
									</div>
									<div id="collapseHighlight" class="collapse show" aria-labelledby="collapse-status" data-parent="#accordionExample">
										<div class="card-body">
											<div class="form-check">
												<?php if ( !empty(set_value('highlight')) || $res_pages['highlight'] == 'Y' ): ?>

												<input class="form-check-input" type="checkbox" id="chighlighta" name="highlight" value="1" checked>
												<label class="form-check-label" for="chighlighta">Highlight</label>
												
												<?php else: ?>

												<input class="form-check-input" type="checkbox" id="chighlightb" name="highlight" value="1">
												<label class="form-check-label" for="chighlightb">Highlight</label>
