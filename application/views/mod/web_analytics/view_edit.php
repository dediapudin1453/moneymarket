...
<div class="content">
	...
	<div class="block">
		<div class="block-header">
			<h3><?php echo lang_line('mod_title_edit');?> - <?= $res_pages['type']; ?></h3>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group mb-0">
							...
							<textarea id="analytics" name="analytics" class="form-control" rows="11" style="border-radius:0px;"><?=!empty(set_value('analytics')) ? set_value('analytics') : $res_pages['analytics'];?></textarea>
							<div class="form-input-error"><?=form_error('analytics');?></div>
						</div>
						<!--/ Content -->
					</div>
				</div>
